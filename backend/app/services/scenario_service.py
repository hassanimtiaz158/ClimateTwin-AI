...
class ScenarioService:
    """Handles scenario creation, retrieval, update, and deletion."""
    ...
    async def create(self, config: ScenarioCreate) -> Scenario:
        ...
        logger.info(f"Creating scenario: {config.name} ({config.city}, {config.country})")
    ...
    async def update(self, scenario_id: UUID, data: ScenarioUpdate) -> Optional[Scenario]:
